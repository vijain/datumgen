 ...
 *
 */
public class DummyObjectDataTblModel extends AbstractTableModel implements IAttributeDataModel
{
	//static Logger logger = Logger.getLogger(AttributeDataModel.class);
	Vector vec = null;
	String [] columnHeader = {" ","Attributes","Setter Methods","Value"};
	...
	public DummyObjectDataTblModel()
	{
		vec = new Vector();
//		createModel();
	}
	...
	public void setValueAt(Object obj, int row, int column) 
	{
		...
		switch(column)
		{
			...
			case 3: data.setValue(obj); break;
			default: break;
		}
