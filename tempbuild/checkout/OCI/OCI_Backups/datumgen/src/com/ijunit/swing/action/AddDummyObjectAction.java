...
import com.ijunit.swing.view.AddDummyObjectView;
 ...
 *
 */
public class AddDummyObjectAction implements ActionListener, ListSelectionListener, DropTargetListener, ChangeListener
{
	static Logger logger = Logger.getLogger(AddDummyObjectAction.class);
	private AddDummyObjectView view;
	private IAttributeDataModel model;
	
	
	public AddDummyObjectAction(Component view, IAttributeDataModel model)
	{
		logger.debug("In the AddObjectAction");
		this.view = (AddDummyObjectView)view;
		this.model = model;
	}
